...
console.log(student);
console.log(
  `Bonjour éléve ${student.firstname}, ${student.lastname} et ${student.age} ans`
);
...
console.log(student2.notes[student2.notes.length - 1]);
console.log(
  `Bonjour  ${student2.firstname}, ${student2.lastname} vous avez ${
    student.age} ans et votre dernière note est ${student2.notes[student2.notes.length - 1]} `);
